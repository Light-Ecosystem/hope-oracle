 ...
 */
contract WstETHSynchronicityPriceAdapterL2 is IHESynchronicityPriceAdapter {
  /**
   ...
   */
  constructor(address pegToBaseAggregatorAddress, address assetToPegAggregatorAddress, uint8 _decimals) {
